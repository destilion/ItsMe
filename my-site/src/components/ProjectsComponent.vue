    ...
    <div class="container-md">
      <div class="project">
        ...
        <div class="project-info">
          ...
          about websdesign. The site is pretty simple at the momenmt but I am hoping to improve it as time goes on and
          add more features.
      ...
      <div class="project">
        ...
        <div class="project-info">
          <div>
            ...
            to create an audio visualizer. Features planned to include are google home support, phone/webapp to control
            lights, and sync with other RGB lights depending on feasability.
            <div>
